...
**Prerequisites covered:** .NET 8, 9, or 10, Neo4j, NuGet packages, DI configuration, first memory store.
...
|-------------|---------|-------|
| .NET SDK | **8.0, 9.0, or 10.0** | [Download](https://dotnet.microsoft.com/download) |
