...
*This document supersedes the multi-user/isolation aspects of earlier plans and complements `docs/archive/Implementation_Plan_Remediation.md` (closed/archived), `docs/architecture.md`, and `docs/schema.md`.*
