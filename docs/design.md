...
| 5 | `IShortTermMemoryService` | Conversation and message operations | `AddConversationAsync`, `AddMessageAsync`, `AddMessagesAsync`, `GetRecentMessagesAsync`, `GetConversationMessagesAsync`, `SearchMessagesAsync`, `ClearSessionAsync` |
| 6 | `ILongTermMemoryService` | Entity, fact, preference, relationship operations | `AddEntityAsync`, `GetEntitiesByNameAsync`, `SearchEntitiesAsync`, `AddPreferenceAsync`, `GetPreferencesByCategoryAsync`, `SearchPreferencesAsync`, `AddFactAsync`, `GetFactsBySubjectAsync`, `SearchFactsAsync`, `AddRelationshipAsync`, `GetEntityRelationshipsAsync` |
