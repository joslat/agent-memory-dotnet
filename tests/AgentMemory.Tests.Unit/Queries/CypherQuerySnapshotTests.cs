...
public sealed class CypherQuerySnapshotTests
{
    ...
    {
        "ConsolidationRun", "Conversation", "Entity", "EntitySummary", "Extractor", "Fact",
        "MemoryReadAudit", "Message",
        "Migration", "Preference", "ReasoningStep", "ReasoningTrace",
        "Schema", "Tool", "ToolCall",
        // 30.4: upstream's own identity label, adopted by the working-memory extension.
        "User"
    };
