...
using AgentMemory.Abstractions.Domain.Extraction.Streaming;
using AgentMemory.Core.Extraction.Streaming;

namespace AgentMemory.Tests.Unit.Extraction.Streaming;
